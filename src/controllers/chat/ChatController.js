import { chatBasicRules,chatBasicReceiveRules,chatRoomBasicRules, validator } from "../../helper/validator.js";
...
export async function receive_message(req,res){
  ...
  let results = {};
  try {
    let result1 = await RiderClientChat.find( { from_user_id: body.from_user_id, to_user_id:body.to_user_id  } )
    results = {
      status: 0,
      msg: "Success",
      data: result1
...
export async function rider_admin_receive_message(req,res){
  ...
  let results = {};
  try {
    let result1 = await RiderAdminChat.find( { from_user_id: body.from_user_id, to_user_id:body.to_user_id  } )
    results = {
      status: 0,
      msg: "Success",
      data: result1
...
export async function restaurant_admin_receive_message(req,res){
  ...
  let results = {};
  try {
    let result1 = await RestaurantAdminChat.find( { from_user_id: body.from_user_id, to_user_id:body.to_user_id  } )
    results = {
      status: 0,
      msg: "Success",
      data: result1
